...
-- Optional: Add a CHECK constraint to prevent updates at the database level
-- This adds an extra layer of protection
ALTER TABLE public.audit_logs 
  ADD CONSTRAINT audit_logs_no_update 
...
-- Log this security fix in the audit trail itself
...
VALUES (
  ...
  'audit_logs',
  jsonb_build_object(
    'fix', 'Removed dangerous DELETE and UPDATE policies',
    'reason', 'Audit logs must be immutable for security integrity',
    'timestamp', now()
  )
);