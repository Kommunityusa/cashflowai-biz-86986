  ...
  const plans = [
    {
      ...
      popular: true,
      features: [
        { text: "Save 10+ hours per month on bookkeeping", included: true },
        { text: "Maximize tax deductions with AI guidance", included: true },
        { text: "Make confident financial decisions with real-time insights", included: true },
        { text: "Stay tax-ready year-round", included: true },
        { text: "Eliminate manual categorization work", included: true },
        { text: "Access your financials anytime, anywhere", included: true },
        { text: "Reduce accounting costs by up to 70%", included: true },
        { text: "Get expert support when you need it", included: true },
      ],
      cta: "Subscribe Now",
